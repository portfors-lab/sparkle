...
class QProtocolTabelModel(QtCore.QAbstractTableModel):
    ...
    def removeTest(self, position):
        """See :meth:`ProcotolModel<spikeylab.run.protocol_model.ProtocolTabelModel.remove>`"""
    ...
    def insertTest(self, stim, position):
        """See :meth:`ProcotolModel<spikeylab.run.protocol_model.ProtocolTabelModel.insert>`"""
        if position == -1:
    ...
    def clearTests(self):
        """See :meth:`ProcotolModel<spikeylab.run.protocol_model.ProtocolTabelModel.clear>`"""
        self.beginRemoveRows(QtCore.QModelIndex(), 0, self.rowCount()-1)
        self._testmodel.clear()
        self.endRemoveRows()

    def stimulusList(self):
        """See :meth:`ProcotolModel<spikeylab.run.protocol_model.ProtocolTabelModel.allTests>`"""
        return self._testmodel.allTests()

    def verify(self, windowSize=None):
        """See :meth:`ProcotolModel<spikeylab.run.protocol_model.ProtocolTabelModel.verify>`"""
