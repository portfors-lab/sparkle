...
#
# Created: Fri Mar 28 11:29:50 2014
...
class Ui_CalibrationWidget(object):
    def setupUi(self, CalibrationWidget):
        ...
        self.test_type_grp = QtGui.QGroupBox(CalibrationWidget)
        self.test_type_grp.setEnabled(True)
        ...
        self.label_2 = QtGui.QLabel(self.test_type_grp)
        ...
        self.nreps_spnbx = QtGui.QSpinBox(self.test_type_grp)
        self.nreps_spnbx.setMaximumSize(QtCore.QSize(100, 16777215))
        self.nreps_spnbx.setObjectName(_fromUtf8("nreps_spnbx"))
        self.horizontalLayout.addWidget(self.nreps_spnbx)
        self.verticalLayout.addWidget(self.test_type_grp)
        self.caleditor_stack = QtGui.QStackedWidget(CalibrationWidget)
        ...
        self.verticalLayout.addWidget(self.caleditor_stack)
