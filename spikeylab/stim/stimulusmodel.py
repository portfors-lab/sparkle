...
class StimulusModel():
    ...
    def setCalibration(self, dbBoostArray, frequencies, frange):
        ...
        :param dbBoostArray: frequency response of the system
    ...
    def setAutoParams(self, params):
        ...
        :type params: AutoParameterModel
        """
        self._autoParams = params

    def autoParams(self):
        """Returns the AutoParameterModel for this stimulus"""
    ...
    def insertComponent(self, comp, row=0, col=0):
        ...
        :type comp: AbstractStimulusComponent
    ...
    def indexByComponent(self, component):
        ...
        :type component: AbstractStimulusComponent
    ...
    def contains(self, stimtype):
        ...
        :param stimtype: AbstractStimulusComponent class name to test for membership in the components of this stimulus
        :type stimtype: str
    ...
    def loadFromTemplate(template, stim=None):
        ...
        :type template: dict
        :param stim: Stimulus to apply to
    ...
    def duration(self):
        """Returns the duration of the stimulus, in seconds"""
        durs = []
        for track in self._segments:
    ...
    def signal(self):
        """Returns the current stimulus in signal representation"""
    ...
    def componentDoc(self, starttime=True):
        """Returns the documentation for the components, as a dict"""
        samplerate = self.samplerate()
        doc_list = []
    ...
    def testDoc(self):
        """Returns the documentation for the entire test (applies to all autoparams)"""
