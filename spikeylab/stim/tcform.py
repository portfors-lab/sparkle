...
#
# Created: Thu Jan 23 13:04:42 2014
...
class Ui_TuningCurveEditor(object):
    def setupUi(self, TuningCurveEditor):
        ...
        self.funit_lbl_3 = QtGui.QLabel(TuningCurveEditor)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.risefall_spnbx = QtGui.QSpinBox(TuningCurveEditor)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.dur_spnbx = QtGui.QSpinBox(TuningCurveEditor)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.dur_spnbx.setFont(font)
        self.dur_spnbx.setMinimum(1)
        self.dur_spnbx.setMaximum(5000)
    ...
    def retranslateUi(self, TuningCurveEditor):
        ...
        self.funit_lbl_3.setText(_translate("TuningCurveEditor", "kHz", None))
