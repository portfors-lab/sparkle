...
#
# Created: Wed Jun 18 15:59:49 2014
...
class Ui_ControlWindow(object):
    def setupUi(self, ControlWindow):
        ...
        self.label_4 = QtGui.QLabel(self.tabExplore)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.verticalLayout_8.addWidget(self.label_4)
        self.listWidget_2 = QtGui.QListWidget(self.tabExplore)
        ...
        self.gridLayout_6.addWidget(self.overAttenLbl, 0, 1, 1, 1)
        ...
        self.dblevelLbl.setObjectName(_fromUtf8("dblevelLbl"))
        self.gridLayout_3.addWidget(self.dblevelLbl, 0, 1, 1, 1)
        self.label_18 = QtGui.QLabel(self.tabCalibrate)
        self.label_18.setObjectName(_fromUtf8("label_18"))
        self.gridLayout_3.addWidget(self.label_18, 0, 0, 1, 1)
        self.dblevelLbl2 = QtGui.QLabel(self.tabCalibrate)
        self.dblevelLbl2.setObjectName(_fromUtf8("dblevelLbl2"))
        self.gridLayout_3.addWidget(self.dblevelLbl2, 1, 1, 1, 1)
        self.overAttenLbl_2 = QtGui.QLabel(self.tabCalibrate)
        self.overAttenLbl_2.setObjectName(_fromUtf8("overAttenLbl_2"))
        self.gridLayout_3.addWidget(self.overAttenLbl_2, 2, 1, 1, 1)
