...
class Ui_CalibrationWindow(object):
    def setupUi(self, CalibrationWindow):
        ...
        self.aisr_units.setObjectName(_fromUtf8("aisr_units"))
        ...
        self.dur_units.setObjectName(_fromUtf8("dur_units"))
        ...
        self.f_units.setObjectName(_fromUtf8("f_units"))
        ...
        self.risefall_units.setObjectName(_fromUtf8("risefall_units"))
        ...
        self.interval_units.setObjectName(_fromUtf8("interval_units"))
        ...
        self.sr_units.setObjectName(_fromUtf8("sr_units"))
    ...
    def retranslateUi(self, CalibrationWindow):
        ...
        self.aisr_units.setText(_translate("CalibrationWindow", "kHz", None))
        self.dur_units.setText(_translate("CalibrationWindow", "ms", None))
        ...
        self.f_units.setText(_translate("CalibrationWindow", "kHz", None))
        self.risefall_units.setText(_translate("CalibrationWindow", "ms", None))
        ...
        self.interval_units.setText(_translate("CalibrationWindow", "ms", None))
        self.label_13.setText(_translate("CalibrationWindow", "Frequency", None))
        self.sr_units.setText(_translate("CalibrationWindow", "kHz", None))
        ...
        self.flabel.setText(_translate("CalibrationWindow", "Frequency:", None))
        self.dblabel.setText(_translate("CalibrationWindow", "Intensity:", None))
        self.label0.setText(_translate("CalibrationWindow", "AO Voltage :", None))
        self.label1.setText(_translate("CalibrationWindow", "AI Voltage", None))
        self.label2.setText(_translate("CalibrationWindow", "FFT peak", None))
        self.label3.setText(_translate("CalibrationWindow", "FFT at f", None))
        self.label4.setText(_translate("CalibrationWindow", "db SPL", None))
