...
class Ui_DisplayDlg(object):
    def setupUi(self, DisplayDlg):
        DisplayDlg.setObjectName(_fromUtf8(u"DisplayDlg"))
        ...
        self.caldb_lnedt.setObjectName(_fromUtf8(u"caldb_lnedt"))
        ...
        self.chunksz_lnedt.setObjectName(_fromUtf8(u"chunksz_lnedt"))
        ...
        self.calV_lnedt.setObjectName(_fromUtf8(u"calV_lnedt"))
        ...
        self.calkhz_lnedt.setObjectName(_fromUtf8(u"calkhz_lnedt"))
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8(u"accepted()")), DisplayDlg.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8(u"rejected()")), DisplayDlg.reject)
        QtCore.QMetaObject.connectSlotsByName(DisplayDlg)

    def retranslateUi(self, DisplayDlg):
        DisplayDlg.setWindowTitle(_translate(u"DisplayDlg", u"Display Options", None))
        self.label_3.setText(_translate(u"DisplayDlg", u"Calibration intensity", None))
        self.label.setText(_translate(u"DisplayDlg", u"acquisition chunk size", None))
        self.label_2.setText(_translate(u"DisplayDlg", u"samples", None))
        self.label_4.setText(_translate(u"DisplayDlg", u"Voltage at  cal dB", None))
        self.label_6.setText(_translate(u"DisplayDlg", u"dB", None))
        self.label_5.setText(_translate(u"DisplayDlg", u"V", None))
        self.label_7.setText(_translate(u"DisplayDlg", u"Calibration frequency", None))
        self.label_8.setText(_translate(u"DisplayDlg", u"kHz", None))
