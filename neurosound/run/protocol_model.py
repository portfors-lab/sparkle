...
class ProtocolTabelModel():
    ...
    def setReferenceVoltage(self, caldb, calv):
        """See :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.setReferenceVoltage>`"""
        self.caldb = caldb
        self.calv = calv
    ...
    def setCalibration(self, db_boost_array, frequencies, frange):
        ...
        See :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.setCalibration>`"""
    ...
    def allTests(self):
        ...
        :returns: list<:class:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel>`>
        """
    ...
    def insert(self, stim, position):
        ...
        :type stim: :class:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel>`
