...
from neurosound.run.calibration_runner import CalibrationRunner, CalibrationCurveRunner
from neurosound.run.microphone_calibration_runner import MphoneCalibrationRunner
...
class AcquisitionManager():
    ...
    def explore_stimulus(self):
        ...
        :returns: list<:class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`> -- list of the stimuli classes instances in the search operation
        """
    ...
    def set(self, **kwargs):
        ...
        See :meth:`AbstractAcquisitionRunner<neurosound.run.abstract_acquisition.AbstractAcquisitionRunner.set>`
        """
    ...
    def protocol_model(self):
        ...
        :returns: :class:`ProtocolModel<neurosound.run.protocol_model.ProtocolTabelModel>`
        """
    ...
    def calibration_stimulus(self, mode):
        ...
        :type mode: str
        :returns: :class:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel>`
        """
        if mode == 'tone':
