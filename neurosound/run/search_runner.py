...
from neurosound.run.abstract_acquisition import AbstractAcquisitionRunner
from neurosound.stim.stimulus_model import StimulusModel
from neurosound.tools.util import increment_title
...
class SearchRunner(AbstractAcquisitionRunner):
    ...
    def stimulus(self):
        ...
        :returns: (subclasses of) list<:class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`>
        """
        return self._stimulus

    def set_calibration(self, attenuations, freqs, frange, calname):
        """See :meth:`AbstractAcquisitionRunner<neurosound.run.abstract_acquisition.AbstractAcquisitionRunner.set_calibration>`"""
        self._stimulus.setCalibration(attenuations, freqs, frange)

    def update_reference_voltage(self):
        """See :meth:`AbstractAcquisitionRunner<neurosound.run.abstract_acquisition.AbstractAcquisitionRunner.update_reference_voltage>`"""
    ...
    def run(self, interval):
        """See :meth:`AbstractAcquisitionRunner<neurosound.run.abstract_acquisition.AbstractAcquisitionRunner.run>`"""
        self._halt = False
