...
class AbstractAcquisitionRunner(object):
    ...
    def set(self, **kwargs):
        ...
        :type binsz: float
        :param caldb: See :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.setReferenceVoltage>`
        :type caldb: float
        :param calv: See :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.setReferenceVoltage>`
        :type calv: float
        :param datafile: a reference to an open file to save data to
        :type datafile: :class:`AcquisitionData<neurosound.data.dataobjects.AcquisitionData>`
        """
