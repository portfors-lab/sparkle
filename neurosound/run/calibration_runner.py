...
from neurosound.stim.types.stimuli_classes import WhiteNoise, FMSweep, PureTone
from neurosound.tools.audiotools import attenuation_curve, calc_spectrum, \
...
from neurosound.gui.stim.factory import CCFactory
...
class CalibrationRunner(AbstractCalibrationRunner):
    ...
    def set_duration(self, dur):
        """See :meth:`AbstractCalibrationRunner<neurosound.run.calibration_runner.AbstractCalibrationRunner.set_duration>`"""
