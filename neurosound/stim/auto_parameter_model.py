...
class AutoParameterModel():
    ...
    def selection(self, row):
        ...
        :param row: the ith parameter number
        :type row: int
        :returns: list<:class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`>
        """
    ...
    def findFileParam(self, comp):
        ...
        :type comp: :class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`
