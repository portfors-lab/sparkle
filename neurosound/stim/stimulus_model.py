...
class StimulusModel():
    ...
    def setAutoParams(self, params):
        ...
        :type params: :class:`AutoParameterModel<neurosound.stim.auto_parameter_model.AutoParameterModel>`
        """
    ...
    def autoParams(self):
        ...
        :returns: :class:`AutoParameterModel<neurosound.stim.auto_parameter_model.AutoParameterModel>`
        """
    ...
    def component(self, row, col):
        ...
        :type col: int
        :returns: :class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`
        """
        try:
    ...
    def contains(self, stimtype):
        ...
        :param stimtype: :class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>` subclass class name to test for membership in the components of this stimulus
        :type stimtype: str
    ...
    def autoParamRanges(self):
        ...
        See :meth:`AutoParameterModel<neurosound.stim.auto_parameter_model.AutoParameterModel.ranges>`
        """
