...
class CalibrationWidget(QtGui.QWidget):
    ...
    def setCurveModel(self, model):
        ...
        :type model: :class:`StimulusModel <neurosound.stim.stimulus_model.StimulusModel>`
        """
    ...
    def addOption(self, stim):
        ...
        :type stim: :class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`
        """
