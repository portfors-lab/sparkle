from neurosound.gui.plotting.pyqtgraph_widgets import TraceWidget, SpecWidget, FFTWidget
...
class ExtendedCalibrationDisplay(QtGui.QWidget):
    ...
    #     For arguments, see: :meth:`SpecWidget.setSpecArgs<neurosound.gui.plotting.pyqtgraph_widgets.SpecWidget.setSpecArgs>`
    #     """
    ...
    def updateSignal(self, *args, **kwargs):
        ...
        For other arguments, see: :meth:`FFTWidget.updateData<neurosound.gui.plotting.pyqtgraph_widgets.FFTWidget.updateData>`
        """
        p = kwargs.pop('plot')
        if p == 'response':
