...
from neurosound.gui.plotting.viewbox import SpikeyViewBox
...
class SpecWidget(BasePlot):
    ...
    def fromFile(self, fname):
        """Displays a spectrogram of an audio file. Supported formats see :func:`neurosound.tools.audiotools.audioread`
