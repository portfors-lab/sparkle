...
from neurosound.gui.stim.generic_parameters import GenericParameterWidget
from neurosound.gui.stim.components import vocal_parameters, square_parameters
from neurosound.tools.audiotools import spectrogram, audioread, audiorate
from neurosound.resources import img
...
class QStimulusComponent(object):
    ...
    def showEditor(self):
        ...
        Re-implement this method to use custom editor, subclassing :class:`AbstractComponentWidget<neurosound.gui.stim.abstract_component_editor.AbstractComponentWidget>`

        :returns: :class:`GenericParameterWidget<neurosound.gui.stim.generic_parameters.GenericParameterWidget>`
        """
