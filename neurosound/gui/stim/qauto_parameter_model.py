...
class QAutoParameterModel(QtCore.QAbstractTableModel):
    ...
    interface with the :class:`AutoParameterTableView<neurosound.gui.stim.auto_parameter_view.AutoParameterTableView>`"""
    ...
    def checkValidCell(self, index):
        ...
        See :meth:`isFieldValid<neurosound.stim.auto_parameter_model.AutoParameterModel.isFieldValid>`
        """
        col = index.column()
        row = index.row()
    ...
    def findFileParam(self, comp):
        """wrapper for :meth:`findFileParam<neurosound.stim.auto_parameter_model.AutoParameterModel.findFileParam>`"""
    ...
    def verify(self):
        """Wrapper for :meth:`verify<neurosound.stim.auto_parameter_model.AutoParameterModel.verify>`"""
