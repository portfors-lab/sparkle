...
from neurosound.gui.stim.auto_parameter_view import AutoParameterTableView, AddLabel
from neurosound.gui.trashcan import TrashWidget
from neurosound.gui.hidden_widget import WidgetHider
...
class Parametizer(QtGui.QWidget):
    ...
    def view(self):
        ...
        :returns: :class:`AutoParameterTableView<neurosound.gui.stim.auto_parameter_view.AutoParameterTableView>`
        """
    ...
    def setModel(self, model):
        ...
        :type model: :class:`QAutoParameterModel<neurosound.gui.stim.qauto_parameter_model.QAutoParameterModel>`
        """
...
if __name__ == '__main__':
    import sys
    from neurosound.gui.stim.stimulusview import *
