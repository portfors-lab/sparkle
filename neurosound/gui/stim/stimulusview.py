...
from neurosound.gui.abstract_drag_view import AbstractDragView
from neurosound.stim.abstract_component import AbstractStimulusComponent
from neurosound.gui.stim.selectionmodel import ComponentSelectionModel
...
class StimulusView(AbstractDragView, QtGui.QAbstractItemView):
    ...
    def setModel(self, model):
        ...
        :type model: :class:`QStimulusModel<neurosound.gui.stim.stimulus_model.QStimulusModel>`
        """
    ...
    def updateSelectionModel(self, components):
        ...
        :type components: list<:class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`
        """
    ...
    def dropped(self, component, event):
        ...
        :meth:`Re-implemented<neurosound.gui.abstract_drag_view.AbstractDragView.dropped>`
        """
    ...
    def updateDefaults(sender, state):
        ...
        :param sender: Component (:class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`) class name to set the defaults for
        :type sender: str
        :param state: the return value from that component's :meth:`stateDict<neurosound.stim.abstract_component.AbstractStimulusComponent.stateDict>` method
        :type state: dict
        """
    ...
    def updateVocalAuto(self, component, files):
        ...
        *files*. Adds auto-parameter if not already present. The auto-parameter is expected to have only one selected
        ...
        :type component: :class:`AbstractStimulusComponent<neurosound.stim.abstract_component.AbstractStimulusComponent>`
...
class ComponentDelegate(QtGui.QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        """Uses the :meth:`paint<neurosound.gui.stim.components.qcomponents.QStimulusComponent.paint>` 
...
if __name__ == "__main__":
    import sys
    from neurosound.stim.stimulus_model import *
