...
class AbstractStimulusWidget(AbstractEditorWidget):
    """Abstract class for editors for :class:`QStimulusModels<neurosound.gui.stim.qstimulus.QStimulusModel>`"""
    ...
    def model(self):
        ...
        :returns: :class:`QStimulusModel<neurosound.gui.stim.qstimulus.QStimulusModel>`
        """
    ...
    def setModel(self, model):
        ...
        :type model: :class:`QStimulusModel<neurosound.gui.stim.qstimulus.QStimulusModel>`
        """
        raise NotImplementedError
