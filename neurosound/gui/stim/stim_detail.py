...
from neurosound.gui.stim.stim_detail_form import Ui_StimDetailWidget
...
class StimDetailWidget(QtGui.QWidget):
    ...
    def setDoc(self, doc):
        ...
        :meth:`componentDoc<neurosound.stim.stimulus_model.StimulusModel.componentDoc>`
        or :meth:`templateDoc<neurosound.stim.stimulus_model.StimulusModel.templateDoc>`
        """
    ...
    def setDisplayAttributes(self, attrs):
        ...
        Actually just calls :meth:`setDisplayTable<neurosound.gui.stim.component_detail.ComponentsDetailWidget.setDisplayTable>`
        """
