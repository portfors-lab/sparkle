...
from neurosound.tools.audiotools import impulse_response, convolve_filter
from neurosound.stim.types import get_stimuli_models
from neurosound.stim import get_stimulus_editor
...
from neurosound.gui.qconstants import CursorRole, BuildMode, AutoParamMode
from neurosound.resources import cursors
...
class QStimulusModel(QtCore.QAbstractItemModel):
    """Qt wrapper for :class:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel>`"""
    ...
    def columnCountForRow(self, row):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.columnCountForRow>`"""
        return self._stim.columnCountForRow(row)

    def componentCount(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.componentCount>`"""
        return self._stim.componentCount()

    def repCount(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.repCount>`"""
        return self._stim.repCount()

    def setRepCount(self, count):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.setRepCount>`"""
        self._stim.setRepCount(count)

    def traceCount(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.traceCount>`"""
    ...
    def signal(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.signal>`"""
        return self._stim.signal()

    def samplerate(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.samplerate>`"""
        return self._stim.samplerate()

    def duration(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.duration>`"""
    ...
    def updateComponentStartVals(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.updateComponentStartVals>`"""
    ...
    def templateDoc(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.templateDoc>`"""
        doc = self._stim.templateDoc()
        return doc

    def warning(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.warning>`"""
        return self._stim.warning()

    def verify(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.verify>`"""
        return self._stim.verify()

    def purgeAutoSelected(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.purgeAutoSelected>`"""
        self._stim.purgeAutoSelected()

    def cleanComponents(self):
        """Wrapper for :meth:`StimulusModel<neurosound.stim.stimulus_model.StimulusModel.cleanComponents>`"""
