"""
Factory classes for intializing :class:`StimulusModels<neurosound.stim.stimulus_model.StimulusModel>`
...
class StimFactory():
    ...
    def editor(self):
        ...
        :returns: (subclass of) :class:`AbstractStimulusWidget<neurosound.gui.stim.abstract_stim_editor.AbstractStimulusWidget>`      
        """
