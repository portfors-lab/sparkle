...
from neurosound.gui.stim.smart_spinbox import SmartSpinBox, trim
...
class SmartDelegate(QtGui.QStyledItemDelegate):
    """Just a deletegate with a :class:`SmartSpinBox<neurosound.gui.stim.smart_spinbox.SmartSpinBox>`"""
    _scales = ['ms', 'kHz']
    def createEditor(self, parent, option, index):
